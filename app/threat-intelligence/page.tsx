    ...
    <div className="min-h-screen bg-white">
      ...
      <Alert className="border-l-4 border-l-red-500 bg-red-50 rounded-none">
        ...
        <AlertDescription className="text-red-800">
          <strong>Threat Intelligence Alerts:</strong> CREW notices are distributed immediately when critical threats are identified
        </AlertDescription>
      </Alert>
      ...
      <div className="bg-gray-50 border-b">
        <div className="container mx-auto px-4 py-3">
          <nav className="text-sm text-gray-600">
            ...
            <span className="text-gray-900">Threat Intelligence</span>
          </nav>
        </div>
      </div>
      ...
      <main>
            ...
            <div className="max-w-4xl">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-xl opacity-90">CREW notices, TIPRs, and threat analysis</p>
                </div>
              </div>
              <p className="text-lg mb-8 opacity-90 max-w-3xl">
                SC3 provides comprehensive threat intelligence services to help Scottish organisations understand and
                respond to the evolving cyber threat landscape through early warning systems, detailed analysis, and
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  ...
                  asChild
                >
                  <Link href="https://cyberscotland.com" target="_blank">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Threat Intelligence Services</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Comprehensive threat intelligence capabilities designed to enhance your organisation's security posture
              </p>
            </div>
                  ...
                  <Card key={index} className="hover:shadow-lg transition-shadow">
                    <CardContent className="p-8">
                      <div className="flex items-start space-x-6">
                        <div className={`w-16 h-16 ${service.bgColor} rounded-lg flex items-center justify-center flex-shrink-0`}>
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="flex space-x-2">
                              ...
                              <Badge
                                variant="outline"
                                className={
                                  service.classification.includes("SENSITIVE")
                                    ? "border-orange-200 text-orange-800"
                                    : service.classification.includes("TLP")
                          ...
                          <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                              <h4 className="font-medium text-gray-900 mb-3">Access Information:</h4>
                              <p className="text-sm text-gray-600 mb-4">
                                <strong>Eligibility:</strong> {service.access}
                              </p>
                              <Button size="sm" className={`${service.color.replace('text-', 'bg-')} hover:opacity-90`}>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">How to Get Access</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Clear guidance on accessing SC3 threat intelligence services based on your organisation's needs
              </p>
            </div>
                  ...
                  <Card key={index} className="hover:shadow-lg transition-shadow">
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-semibold text-gray-900 mb-2">{requirement.service}</h3>
                          <div className="grid md:grid-cols-3 gap-6">
                            <div>
                              <h4 className="font-medium text-gray-900 mb-2">Eligibility:</h4>
                              <p className="text-sm text-gray-600">{requirement.eligibility}</p>
                            </div>
                            <div>
                              <h4 className="font-medium text-gray-900 mb-2">Process:</h4>
                              <p className="text-sm text-gray-600">{requirement.process}</p>
                            </div>
                            <div>
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Why Threat Intelligence Matters</h2>
              <p className="text-xl opacity-90 max-w-2xl mx-auto">
                Proactive threat intelligence enables better security decisions and faster incident response
              </p>
            </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Get Started with Threat Intelligence</h2>
            <div className="max-w-2xl mx-auto">
              <Card className="border-blue-200 bg-blue-50">
                <CardContent className="p-8">
                  <div className="space-y-6">
                    <div>
                      <h3 className="text-xl font-semibold text-blue-800 mb-2">Request Access</h3>
                      <p className="text-blue-700 mb-4">
                        Contact SC3 to discuss your organisation's threat intelligence requirements
                      </p>
                    ...
                    <div className="border-t border-blue-200 pt-6">
                      <h3 className="text-lg font-semibold text-blue-800 mb-2">CyberScotland.com</h3>
                      <p className="text-blue-700 mb-4">Subscribe to our commercial threat intelligence platform</p>
